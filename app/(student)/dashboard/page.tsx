...
import { CourseGridSkeleton as DashboardSkeleton } from '@/components/ui/skeleton';
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="space-y-6 text-center md:text-left">
            ...
            <p className="text-slate-400 font-medium text-lg max-w-lg leading-relaxed italic">
               "{enrollment?.batches?.name || 'Batch 2024'}" is active. Your current streak is 12 days. Keep it up!
            </p>
