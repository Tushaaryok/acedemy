      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <div className="flex-1 relative bg-black flex items-center justify-center group overflow-hidden">
          <div className="w-full h-full relative cursor-none">
             {/* Virtual Screen Placeholder */}
             <div className="absolute inset-0 bg-slate-900 overflow-hidden">
                 {/* Simulated Content / Screen Share */}
                 <div className="absolute inset-0 bg-gradient-to-br from-indigo-950/30 to-transparent"></div>
                 <div className="absolute inset-10 border-2 border-white/5 rounded-[40px] flex flex-col items-center justify-center space-y-8">
                    <motion.div 
                      animate={{ scale: [1, 1.05, 1] }} 
                      transition={{ repeat: Infinity, duration: 4 }}
                      className="w-32 h-32 bg-white/5 rounded-full flex items-center justify-center border border-white/10 shadow-2xl"
                    >
                       <Play size={60} fill="white" className="ml-2 hover:scale-125 transition-transform cursor-pointer" />
                    </motion.div>
                    <div className="text-center space-y-2">
                       <p className="text-sm font-black uppercase tracking-[0.3em] text-white/40">Secure Academic Stream</p>
                       <p className="text-[10px] font-medium text-slate-500">Wait for the teacher to start the broadcast or refresh the portal.</p>
                    </div>
                 </div>
             </div>
