...
import { CourseGridSkeleton } from '@/src/components/Global/Skeleton';
...
export default function CourseCatalog() {
  ...
  useEffect(() => {
    async function fetchCourses() {
      ...
      // Mock categories if none exist
      const mockCourses = [
        { id: '1', title: 'Advanced Calculus & Integrations', teacher: 'Prof. S. Ram', rating: 4.9, students: 1240, price: 'FREE', category: 'Math', thumb: '📐' },
        { id: '2', title: 'Organic Chemistry: Masterclass', teacher: 'Dr. Anjali R.', rating: 4.8, students: 950, price: 'PAID', category: 'Chemistry', thumb: '🧪' },
        { id: '3', title: 'Quantum Physics Fundamentals', teacher: 'Prof. S. Ram', rating: 4.9, students: 2100, price: 'PAID', category: 'Physics', thumb: '⚡' },
        { id: '4', title: 'Macro Economics & Policy', teacher: 'Mehta Sir', rating: 4.7, students: 540, price: 'FREE', category: 'Commerce', thumb: '📈' },
      ];
        ...
        {courses.map((course) => (
          <div key={course.id} className="bg-white rounded-[40px] border border-slate-100 shadow-sm overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 flex flex-col">
            ...
            <div className="p-8 flex-1 flex flex-col space-y-4">
               ...
               <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">By {course.teachers?.full_name || course.teacher}</p>
